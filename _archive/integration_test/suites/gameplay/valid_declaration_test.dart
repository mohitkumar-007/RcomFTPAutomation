...
import '../../../lib/pages/gameplay/declaration_page.dart';
...
void main() {
  ...
  patrolTest(
    'TC_VDECL_001 — Valid declaration shows winner screen with 0 points',
    ...
    ($) async {
      ...
      // All four groups form pure/impure sequences — valid declaration
      ...
      await DeclarationPage($).assertValidDeclaration();
